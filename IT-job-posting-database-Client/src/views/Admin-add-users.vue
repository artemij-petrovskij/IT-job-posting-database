    ...
    <v-container>
        ...
        <v-fade-transition>
            ...
            <v-btn to="/edit-advert">Comfortable Button</v-btn> -->
                    <v-card title="Добавить пользователя" class="mx-auto" max-width="700"
                        variant="outlined">
                        ...
                        <v-container class="align-center ">
                            ...
                            <v-form ref="form1" v-model="valid" lazy-validation @submit.prevent="submitForm">
                                ...
                                <v-text-field v-model="name" label="Логин пользователя*" :rules="[rules.required]"
                                    hide-details required>
                                </v-text-field>
                                <v-text-field v-model="description" label="Пароль*"
